            ...
            <div class="row">
               <form method="POST" action="/admin/sejarah/{{ $sejarah->id }}">
                    ...
                    <div class="col">
                        ...
                        <div class="mb-3">
                            <label for="konten" class="form-label">Deskripsi <span style="color: red">*</span></label>
                            <textarea class="form-control" id="editor" name="konten" rows="10">{{ old('konten', $sejarah->konten) }}</textarea>
                            @error('konten')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
