    ...
    <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
            <a href="/" class="d-flex align-items-center text-decoration-none">
                <img src="{{ asset('storage/' . $logo->logo) }}" alt="Logo" width="70" class="me-2">
                <div class="logo-text-admin">
                    <h5 class="mb-0 fw-bold" style="font-size: 16px; line-height: 1.2; color: #1c5c93; font-family: 'Raleway', sans-serif; letter-spacing: 0.5px;">{{ $nm_desa }}</h5>
                    <small style="font-size: 11px; color: #6c757d; font-weight: 500; font-family: 'Open Sans', sans-serif;">{{ $kecamatan }}</small>
                </div>
            </a>
