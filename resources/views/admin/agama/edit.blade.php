      ...
      <div class="card w-100">
        ...
        <div class="card-body">
            <form method="POST" action="/admin/agama/{{ $agama->id }}">
                ...
                <div class="mb-3">
                    <label for="jumlah" class="form-label">Jumlah Penganut <span style="color: red">*</span></label>
                    <input type="number" class="form-control" name="jumlah" id="jumlah" value="{{ old('jumlah', $agama->jumlah) }}" min="0">
                    @error('jumlah')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
