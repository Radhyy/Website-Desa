...
@section('content')
    ...
    <div class="row">
        <form method="POST" action="/admin/apbdes">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="tahun" id="tahun"
                                            value="{{ old('tahun', date('Y')) }}" min="2020" max="2100">
                                        @error('tahun')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="kategori" id="kategori"
                                    value="{{ old('kategori') }}" placeholder="Contoh: Pendapatan Asli Desa">
                                @error('kategori')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="uraian" id="uraian" rows="3" placeholder="Contoh: Hasil Usaha Desa">{{ old('uraian') }}</textarea>
                                @error('uraian')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="jumlah" id="jumlah"
                                    value="{{ old('jumlah') }}" min="0" step="1" placeholder="Contoh: 50000000">
                                @error('jumlah')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
